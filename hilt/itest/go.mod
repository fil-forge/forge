// The integration suite is its own module so that hilt's does not carry a
// dependency hilt's binary never links. It boots the Forge network through
// smelt, which nothing under hilt/ outside this directory imports; keeping
// that in hilt/go.mod forced every build of hilt -- including its Docker
...
module github.com/fil-forge/forge/hilt/itest

go 1.27.0

replace github.com/fil-forge/forge/hilt => ../
