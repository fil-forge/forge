...
import (
	...
	"github.com/fil-forge/forge/commands/ucan/attest"
...
func main() {
	...
	if err := cbg.WriteMapEncodersToFile(cborFile, "attest", models...); err != nil {
		panic(err)
	}
	if err := jsg.WriteMapEncodersToFile(jsonFile, "attest", models...); err != nil {
		panic(err)
	}
	tag(cborFile)
	tag(jsonFile)
