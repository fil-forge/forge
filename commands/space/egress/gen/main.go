...
import (
	...
	"github.com/fil-forge/forge/commands/space/egress"
...
func main() {
	...
	if err := cbg.WriteMapEncodersToFile(cborFile, "egress", models...); err != nil {
		panic(err)
	}
	if err := jsg.WriteMapEncodersToFile(jsonFile, "egress", models...); err != nil {
		panic(err)
	}
	tag(cborFile)
	tag(jsonFile)
