...
import (
	...
	"github.com/fil-forge/forge/sprue/pkg/internal/revision"
)

var (
	// version is the built version.
	// Set with ldflags in .goreleaser.yaml via -ldflags="-X github.com/fil-forge/forge/sprue/pkg/build.version=v{{.Version}}".
	version string
