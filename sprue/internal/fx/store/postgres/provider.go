...
import (
	...
	pgagent "github.com/fil-forge/forge/sprue/pkg/store/agent/postgres"
	blobregistry "github.com/fil-forge/forge/sprue/pkg/store/blob_registry"
	pgblobregistry "github.com/fil-forge/forge/sprue/pkg/store/blob_registry/postgres"
	"github.com/fil-forge/forge/sprue/pkg/store/consumer"
	pgconsumer "github.com/fil-forge/forge/sprue/pkg/store/consumer/postgres"
	"github.com/fil-forge/forge/sprue/pkg/store/customer"
	pgcustomer "github.com/fil-forge/forge/sprue/pkg/store/customer/postgres"
	"github.com/fil-forge/forge/sprue/pkg/store/delegation"
	pgdelegation "github.com/fil-forge/forge/sprue/pkg/store/delegation/postgres"
	"github.com/fil-forge/forge/sprue/pkg/store/metrics"
	pgmetrics "github.com/fil-forge/forge/sprue/pkg/store/metrics/postgres"
	"github.com/fil-forge/forge/sprue/pkg/store/replica"
	pgreplica "github.com/fil-forge/forge/sprue/pkg/store/replica/postgres"
	"github.com/fil-forge/forge/sprue/pkg/store/revocation"
	pgrevocation "github.com/fil-forge/forge/sprue/pkg/store/revocation/postgres"
	spacediff "github.com/fil-forge/forge/sprue/pkg/store/space_diff"
	pgspacediff "github.com/fil-forge/forge/sprue/pkg/store/space_diff/postgres"
	storageprovider "github.com/fil-forge/forge/sprue/pkg/store/storage_provider"
	pgstorageprovider "github.com/fil-forge/forge/sprue/pkg/store/storage_provider/postgres"
	"github.com/fil-forge/forge/sprue/pkg/store/subscription"
	pgsubscription "github.com/fil-forge/forge/sprue/pkg/store/subscription/postgres"
	"github.com/fil-forge/forge/sprue/pkg/store/upload"
	pgupload "github.com/fil-forge/forge/sprue/pkg/store/upload/postgres"

	// Reuse the AWS S3 client constructor for the three stores that keep an S3 half.
	awsstore "github.com/fil-forge/forge/sprue/internal/fx/store/aws"
