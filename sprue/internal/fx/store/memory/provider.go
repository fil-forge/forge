...
import (
	...
	memagent "github.com/fil-forge/forge/sprue/pkg/store/agent/memory"
	blobregistry "github.com/fil-forge/forge/sprue/pkg/store/blob_registry"
	memblobregistry "github.com/fil-forge/forge/sprue/pkg/store/blob_registry/memory"
	"github.com/fil-forge/forge/sprue/pkg/store/consumer"
	memconsumer "github.com/fil-forge/forge/sprue/pkg/store/consumer/memory"
	"github.com/fil-forge/forge/sprue/pkg/store/customer"
	memcustomer "github.com/fil-forge/forge/sprue/pkg/store/customer/memory"
	"github.com/fil-forge/forge/sprue/pkg/store/delegation"
	memdelegation "github.com/fil-forge/forge/sprue/pkg/store/delegation/memory"
	"github.com/fil-forge/forge/sprue/pkg/store/metrics"
	memmetrics "github.com/fil-forge/forge/sprue/pkg/store/metrics/memory"
	"github.com/fil-forge/forge/sprue/pkg/store/replica"
	memreplica "github.com/fil-forge/forge/sprue/pkg/store/replica/memory"
	"github.com/fil-forge/forge/sprue/pkg/store/revocation"
	memrevocation "github.com/fil-forge/forge/sprue/pkg/store/revocation/memory"
	spacediff "github.com/fil-forge/forge/sprue/pkg/store/space_diff"
	memspacediff "github.com/fil-forge/forge/sprue/pkg/store/space_diff/memory"
	storageprovider "github.com/fil-forge/forge/sprue/pkg/store/storage_provider"
	memstorageprovider "github.com/fil-forge/forge/sprue/pkg/store/storage_provider/memory"
	"github.com/fil-forge/forge/sprue/pkg/store/subscription"
	memsubscription "github.com/fil-forge/forge/sprue/pkg/store/subscription/memory"
	"github.com/fil-forge/forge/sprue/pkg/store/upload"
	memupload "github.com/fil-forge/forge/sprue/pkg/store/upload/memory"
	"go.uber.org/fx"
)
