...
Watch the [latest releases](https://github.com/fil-forge/forge/piri/releases/latest) and upgrade promptly when a new version is published; release notes will call out any operator actions or migrations needed.
