...
// GetProviderStatus reports the provider's registration state entirely from
// on-chain data (the ServiceProviderRegistry and service contracts). There is no
// local "pending" tracking — a provider is either registered on-chain or not.
