...
Download the [indexing service binary from the latest release](https://github.com/fil-forge/forge/indexing-service/releases/latest) based on your system architecture, or download and install the [indexing-service](https://github.com/fil-forge/forge/indexing-service) package using the Go package manager:

```bash
$ go install github.com/fil-forge/forge/indexing-service/cmd@latest
