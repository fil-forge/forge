...
import (
	...
	"github.com/fil-forge/forge/protocol/commands/index"
...
func main() {
	...
	if err := cbg.WriteMapEncodersToFile(cborFile, "index", models...); err != nil {
		panic(err)
	}
	if err := jsg.WriteMapEncodersToFile(jsonFile, "index", models...); err != nil {
		panic(err)
	}
	tag(cborFile)
	tag(jsonFile)
