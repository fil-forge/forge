...
import (
	...
	"github.com/fil-forge/forge/protocol/commands/debug"
...
func main() {
	...
	if err := cbg.WriteMapEncodersToFile(cborFile, "debug", models...); err != nil {
		panic(err)
	}
	if err := jsg.WriteMapEncodersToFile(jsonFile, "debug", models...); err != nil {
		panic(err)
	}
	tag(cborFile)
	tag(jsonFile)
