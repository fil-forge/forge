...
import (
	...
	"github.com/fil-forge/forge/protocol/commands/http"
...
func main() {
	...
	if err := cbg.WriteMapEncodersToFile(cborFile, "http", models...); err != nil {
		panic(err)
	}
	if err := jsg.WriteMapEncodersToFile(jsonFile, "http", models...); err != nil {
		panic(err)
	}
	tag(cborFile)
	tag(jsonFile)
