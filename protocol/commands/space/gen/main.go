...
import (
	...
	"github.com/fil-forge/forge/protocol/commands/space"
...
func main() {
	...
	if err := cbg.WriteMapEncodersToFile(cborFile, "space", models...); err != nil {
		panic(err)
	}
	if err := jsg.WriteMapEncodersToFile(jsonFile, "space", models...); err != nil {
		panic(err)
	}
	tag(cborFile)
	tag(jsonFile)
