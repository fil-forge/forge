...
import (
	...
	"github.com/fil-forge/forge/protocol/commands/ucan"
...
func main() {
	...
	if err := cbg.WriteMapEncodersToFile(cborFile, "ucan", models...); err != nil {
		panic(err)
	}
	if err := jsg.WriteMapEncodersToFile(jsonFile, "ucan", models...); err != nil {
		panic(err)
	}
	tag(cborFile)
	tag(jsonFile)
